    ...
    (function (models) {
        var TodoModel = (function () {
            ...
            TodoModel.prototype.inform = function () {
                ...
                this.onChanges.forEach(function (cb) { return cb(); });
            };
            ...
            TodoModel.prototype.toggle = function (todoToggle) {
                this.todos = this.todos.map(function (todo) {
            ...
            TodoModel.prototype.save = function (todoToSave, text) {
                this.todos = this.todos.map(function (todo) { return todo !== todoToSave ? todo : app.miscelanious.Utils.extend({}, todo, { title: text }); });
                this.inform();
            };
